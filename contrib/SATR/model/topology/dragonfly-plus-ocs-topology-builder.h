#ifndef SATR_DRAGONFLY_PLUS_OCS_TOPOLOGY_BUILDER_H
#define SATR_DRAGONFLY_PLUS_OCS_TOPOLOGY_BUILDER_H
...
class DragonflyPlusOcsTopologyBuilder
{
  public:
    struct BuildOptions
    {
        ...
        bool enableOcs = true;
        bool interPodElectricalFullMesh = false;
    ...
    NodeIndex BuildElectricalOnly(const SimulationConfig& config, const BuildOptions& options) const;
};

} // namespace satr
} // namespace ns3

#endif /* SATR_DRAGONFLY_PLUS_OCS_TOPOLOGY_BUILDER_H */
