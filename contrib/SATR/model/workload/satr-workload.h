#ifndef SATR_WORKLOAD_H
#define SATR_WORKLOAD_H
...
TrafficMatrix BuildAiStructuralTrafficMatrix(const std::string& trafficModel,
                                           double offeredLoad,
...
std::vector<FlowSpec> BuildSatrFlowsFromMatrix(const TrafficMatrix& matrix,
