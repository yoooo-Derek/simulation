...
CSV_FIELDS = [
    ...
    "carrierPositivePairCount",
    "carrierReachablePairCount",
    "carrierUnreachableBytes",
    "carrierUnreachablePairs",
    "carrierWeightedByteHop",
    "carrierWeightedAvgHop",
    "carrierMaxHop",
    "carrierGraphDiameter",
    "oneHopPathFlows",
    "twoHopPathFlows",
    "multiHopPathFlows",
    "avgPathHopCount",
