#!/usr/bin/env python3
"""Plot SMTRA average link utilization curves from performance-summary.csv."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate a paper-style link utilization line chart from SMTRA performance CSV data."
    )
    parser.add_argument(
        "--csv",
        type=Path,
