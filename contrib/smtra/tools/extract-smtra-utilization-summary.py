...
OUTPUT_FIELDS = [
    ...
    "p90LinkUtilization",
    "p95LinkUtilization",
    "avgOcsLinkUtilization",
    "p90OcsLinkUtilization",
    "p95OcsLinkUtilization",
    "avgElectricalLinkUtilization",
...
def main():
    parser = argparse.ArgumentParser(
        description="Extract SMTRA average and percentile link utilization summary."
    )
            ...
            writer.writerow(
                {
                    ...
                    "p90LinkUtilization": row["p90LinkUtilization"],
                    "p95LinkUtilization": row["p95LinkUtilization"],
                    "avgOcsLinkUtilization": row["ocsLinkUtilization"],
                    "p90OcsLinkUtilization": row["p90OcsLinkUtilization"],
                    "p95OcsLinkUtilization": row["p95OcsLinkUtilization"],
                    "avgElectricalLinkUtilization": row["electricalLinkUtilization"],
                    "p90ElectricalLinkUtilization": row["p90ElectricalLinkUtilization"],
                    "p95ElectricalLinkUtilization": row["p95ElectricalLinkUtilization"],
                }
            )
