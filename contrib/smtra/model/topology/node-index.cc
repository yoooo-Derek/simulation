...
NodeIndex::SetLeafNodes(uint32_t groupId, const NodeContainer& leaves)
{
    ...
    {
        throw std::out_of_range("SMTRA group leaf index is out of range");
    }
...
NodeIndex::SetGroupSpineNodes(uint32_t groupId, const NodeContainer& spines)
{
    ...
    {
        throw std::out_of_range("SMTRA group spine index is out of range");
    }
...
NodeIndex::SetServerIpv4Address(uint32_t torId, uint32_t serverId, Ipv4Address address)
{
    ...
    {
        throw std::out_of_range("SMTRA server address index is out of range");
    }
...
NodeIndex::SetOcsServerIpv4Address(uint32_t torId, uint32_t serverId, Ipv4Address address)
{
    ...
    {
        throw std::out_of_range("SMTRA OCS server address index is out of range");
    }
...
NodeIndex::SetServerLinkInfo(uint32_t torId, uint32_t serverId, const ServerLinkInfo& linkInfo)
{
    ...
    {
        throw std::out_of_range("SMTRA server link index is out of range");
    }
...
NodeIndex::SetTorIngressDevice(uint32_t torId, uint32_t serverId, Ptr<NetDevice> device)
{
    ...
    {
        throw std::out_of_range("SMTRA ToR ingress device index is out of range");
    }
...
NodeIndex::AddTorSpineLink(const TorSpineLinkInfo& linkInfo)
{
    ...
    {
        throw std::out_of_range("SMTRA EPS ToR-spine link index is out of range");
    }
...
NodeIndex::AddLeafSpineLink(const LeafSpineLinkInfo& linkInfo)
{
    ...
    {
        throw std::out_of_range("SMTRA leaf-spine link index is out of range");
    }
...
NodeIndex::AddOpticalAccessLink(const OpticalAccessLinkInfo& linkInfo)
{
    ...
    {
        throw std::out_of_range("SMTRA optical access link index is out of range");
    }
...
NodeIndex::AddOcsLink(const OcsLinkInfo& linkInfo)
{
    ...
    {
        throw std::out_of_range("SMTRA OCS link ToR index is out of range");
    }
    if (m_memsCount > 0)
    {
        ...
        {
            throw std::out_of_range("SMTRA active optical circuit is not backed by MEMS access");
        }
    }
...
NodeIndex::GetServer(uint32_t torId, uint32_t serverId) const
{
    ...
    {
        throw std::out_of_range("SMTRA server index is out of range");
    }
...
NodeIndex::GetTor(uint32_t torId) const
{
    ...
    {
        throw std::out_of_range("SMTRA ToR index is out of range");
    }
...
NodeIndex::GetSpine(uint32_t spineId) const
{
    ...
    {
        throw std::out_of_range("SMTRA spine index is out of range");
    }
...
NodeIndex::GetLeaf(uint32_t groupId, uint32_t leafId) const
{
    ...
    {
        throw std::out_of_range("SMTRA leaf index is out of range");
    }
...
NodeIndex::GetMems(uint32_t memsId) const
{
    ...
    {
        throw std::out_of_range("SMTRA MEMS index is out of range");
    }
...
NodeIndex::GetTorSpineLink(uint32_t torId, uint32_t spineId) const
{
    ...
    {
        throw std::out_of_range("SMTRA EPS ToR-spine link does not exist");
    }
    return match->second;
}
...
NodeIndex::GetLeafSpineLink(uint32_t groupId, uint32_t leafId, uint32_t spineId) const
{
    ...
    {
        throw std::out_of_range("SMTRA leaf-spine link does not exist");
    }
    return match->second;
}
...
NodeIndex::GetOpticalAccessLink(uint32_t groupId, uint32_t spineId, uint32_t memsId) const
{
    ...
    {
        throw std::out_of_range("SMTRA optical access link does not exist");
    }
    return match->second;
}
...
NodeIndex::GetOcsLink(uint32_t torA, uint32_t torB) const
{
    ...
    {
        throw std::out_of_range("SMTRA OCS link does not exist for ToR pair");
    }
...
NodeIndex::GetOcsLink(uint32_t torA, uint32_t torB, uint32_t memsId) const
{
    ...
    if (match == links.end())
    {
        throw std::out_of_range("SMTRA OCS link does not exist for ToR pair and MEMS");
    }
    return *match;
}
...
NodeIndex::GetOcsPeerAddress(uint32_t sourceTor, uint32_t destinationTor) const
{
    ...
    throw std::out_of_range("SMTRA OCS peer address requested for non-endpoint ToR");
}
...
NodeIndex::GetOcsInterfaceIndex(uint32_t sourceTor, uint32_t destinationTor) const
{
    ...
    throw std::out_of_range("SMTRA OCS interface requested for non-endpoint ToR");
}
...
NodeIndex::HasPureElectricalPath(uint32_t sourceGroup, uint32_t destinationGroup) const
{
    ...
    {
        throw std::out_of_range("SMTRA group index is out of range");
    }
