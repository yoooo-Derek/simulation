...
class ResultWriter
{
  public:
    std::filesystem::path WriteSmokeSummary(const SimulationConfig& simulation,
                                            ...
                                            std::optional<uint32_t> deferredArrivals = std::nullopt,
                                            std::optional<uint32_t> maxDeferredArrivals = std::nullopt,
                                            std::optional<uint32_t> stageBoundaryBlockedCount = std::nullopt,
                                            std::optional<uint32_t> activeFlowsAtStageBoundary = std::nullopt,
                                            std::optional<uint32_t> finalActiveFlows = std::nullopt,
                                            std::optional<uint32_t> finalWaitingFlows = std::nullopt,
