...
GetSmokeSummaryCsvHeader()
{
    return "schema_version,experiment,scheme,traffic_pattern,run_id,random_seed,num_tors,servers_per_tor,"
           ...
           "install_rate,completion_rate_generated,completion_rate_installed,"
           "uninstalled_flows,installed_incomplete_flows,"
           "avg_receiver_throughput_bps,avg_receiver_throughput_installed_dest_bps,"
           "receiver_count_installed_dest,total_received_bps,"
           "avg_receiver_throughput_fraction_of_access_capacity,avg_fct_s,"
           ...
           "interrupted_flows,residual_flows,deferred_arrivals,max_deferred_arrivals,"
           "stage_boundary_blocked_count,active_flows_at_stage_boundary,"
           "final_active_flows,final_waiting_flows,timeline_cycles,scheduling_round_count,"
